package org.example;// UserController.java
...
public class UserController {
    ...
    public List<UserVO> list() {
        ...
        result.add(new UserVO().setId(1).setUsername("chen"));
        result.add(new UserVO().setId(2).setUsername("wo"));
        result.add(new UserVO().setId(3).setUsername("shi"));
        // 返回列表
        return result;
    }
